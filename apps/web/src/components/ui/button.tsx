...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center border border-transparent bg-clip-padding whitespace-nowrap text-[13px] font-medium tracking-tight transition-all duration-200 outline-none select-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-45 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "rounded-full bg-[#111111] px-3.5 py-2 text-white shadow-soft hover:bg-black active:bg-zinc-900",
        outline:
          "rounded-full border-zinc-200/80 bg-white text-zinc-900 shadow-sm hover:bg-zinc-50 hover:text-foreground aria-expanded:bg-zinc-50",
        secondary:
          "rounded-full bg-[var(--brand-yellow)] text-zinc-900 hover:bg-[var(--brand-yellow-hover)] aria-expanded:bg-[var(--brand-yellow)]",
        ghost:
          "rounded-full text-zinc-700 hover:bg-zinc-100/80 hover:text-zinc-900 aria-expanded:bg-zinc-100",
        destructive:
        ...
        link: "rounded-full text-zinc-900 underline-offset-4 hover:underline",
      },
      size: {
